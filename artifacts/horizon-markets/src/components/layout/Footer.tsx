    ...
    <footer className="bg-[#050505] border-t border-border/40 pt-16 pb-8">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-white/5 pt-8 text-xs text-muted-foreground leading-relaxed space-y-4">
          ...
          <p>
            Horizon Markets operates through various entities globally. "Horizon (SC) Ltd" is incorporated in the Seychelles. "Horizon B.V." is registered in Curaçao. "Horizon (VG) Ltd" is registered in the British Virgin Islands. Services are not intended for distribution to, or use by, any person in any country or jurisdiction where such distribution or use would be contrary to local law or regulation.
          </p>
          <p className="pt-4 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
            <span>&copy; {new Date().getFullYear()} Horizon Markets. All rights reserved.</span>
